...
public class HBaseUtilsTest {
        ...
        public void insertData() {
            ...
            List<Pair<String, String>> pairs2 = Arrays.asList(
                    new Pair<>("name", "Jack"),
                    new Pair<>("age", "33"),
                    new Pair<>("gender", "2"));
            HBaseUtils.putRow(TABLE_NAME, "rowKey2", STUDENT, pairs2);

            List<Pair<String, String>> pairs3 = Arrays.asList(
                    new Pair<>("name", "Mike"),
                    new Pair<>("age", "44"),
                    new Pair<>("gender", "1"));
            HBaseUtils.putRow(TABLE_NAME, "rowKey3", STUDENT, pairs3);

            List<Pair<String, String>> pairs11 = Arrays.asList(
                    new Pair<>("name", "Tom"),
                    new Pair<>("age", "22"),
                    new Pair<>("gender", "1"));
            HBaseUtils.putRow(TABLE_NAME, "rowKey4", TEACHER, pairs11);

            List<Pair<String, String>> pairs21 = Arrays.asList(
                    new Pair<>("name", "Jack"),
                    new Pair<>("age", "33"),
                    new Pair<>("gender", "2"));
            HBaseUtils.putRow(TABLE_NAME, "rowKey5", TEACHER, pairs21);

            List<Pair<String, String>> pairs31 = Arrays.asList(
                    new Pair<>("name", "Mike"),
                    new Pair<>("age", "44"),
                    new Pair<>("gender", "1"));
            HBaseUtils.putRow(TABLE_NAME, "rowKey6", TEACHER, pairs31);
        }

    @Test
    public void insertData2() {
        List<Pair<String, String>> pairs1 = Arrays.asList(
                new Pair<>("name", "TomStudent2"),
                new Pair<>("age", "222"),
                new Pair<>("gender", "2"));
        HBaseUtils.putRow(TABLE_NAME, "rowKey1", STUDENT, pairs1);
    ...
    public void insertData3() {
        List<Pair<String, String>> pairs1 = Arrays.asList(
                new Pair<>("name", "TomTeacher"),
                new Pair<>("age", "22"),
                new Pair<>("gender", "1"));
        HBaseUtils.putRow(TABLE_NAME, "rowKey1", TEACHER, pairs1);
